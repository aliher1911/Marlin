...
#define STRING_CONFIG_H_AUTHOR "(aliher1911, CR-20+BTT 1.4T)" // Who made the changes.
//#define CUSaTOM_VERSION_FILE Version.h // Path from the root directory (no quotes)
...
#define CUSTOM_MACHINE_NAME "CR20-Pro/BTT1.4"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // CR20 Pro - defined but disabled currently 
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 100.00 }
...
// Force z stop pin to probe pin since we don't have separate z-stop
// It will be propagated to z min pin for our homing direction
...
// Enable for fan debugging - force fan 0 (material cool fan) to use power test pin
